    ...
    <div>
        ...
        <form id="register" class="m-t" role="form">
            ...
            <div class="form-group">
                ...
                <label style="float: left" for="carrera">Dinos que carrera estas estudiando</label>

                <select class="form-control m-b" name="carrera" id="carrera">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data == 2) {
                        ...
                        swal({
                            title: "Dominio de correo Invalido",
                            text: "Solo se permite el registro a miembros de la universidad (correos alu.ua.es)",
                            type: "error",
                            showConfirmButton: false,
                            timer: 6000
                        });
